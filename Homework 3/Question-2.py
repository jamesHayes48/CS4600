...
print("Flows rates in m^3/s and liters/min rounded to six decimal places")
print(f"Q1: {answer[0, 0]:.6f} m^3 / s, {answer[0, 0] * 60000:.6f} liters/min")
print(f"Q2: {answer[1, 0]:.6f} m^3 / s, {answer[1, 0] * 60000:.6f} liters/min")

print("Pressures in Pa and Psi rounded to 5 decimal places")
print(f"P0: {answer[2, 0]:.5f} Pa, {answer[2, 0] / 6895:.5f} psi")
print(f"P1: {answer[3, 0]:.5f} Pa, {answer[3, 0] / 6895:.5f} psi")
print(f"P2: {answer[4, 0]:.5f} Pa, {answer[4, 0] / 6895:.5f} psi")
print(f"P3: {answer[5, 0]:.5f} Pa, {answer[5, 0] / 6895:.5f} psi")
print(f"P4: {answer[6, 0]:.5f} Pa, {answer[6, 0] / 6895:.5f} psi")
print(f"P5: {answer[7, 0]:.5f} Pa, {answer[7, 0] / 6895:.5f} psi")
print(f"P6: {answer[8, 0]:.5f} Pa, {answer[8, 0] / 6895:.5f} psi")
